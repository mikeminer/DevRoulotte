...
const contentSecurityPolicy = [
  ...
  "img-src 'self' data: blob: https://shipordie.club https://api.producthunt.com https://peerpush.com https://www.uneed.best https://www.nxgntools.com https://devglobe.app",
  "font-src 'self' data:",
  "media-src 'self' blob:",
...
const nextConfig: NextConfig = {
  ...
  images: {
    remotePatterns: [
      ...
      {
        protocol: "https",
        hostname: "www.nxgntools.com",
        pathname: "/api/embed/devroulottechat",
      },
      {
        protocol: "https",
        hostname: "devglobe.app",
        pathname: "/badges/launched-on-devglobe-dark.svg",
      },
    ],
  },
};
