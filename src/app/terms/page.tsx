    ...
    <LegalPage
      ...
      sections={[
        ...
        },
        {
          title: "Piani",
          body: [
            "Il piano Free ospite include 3 match al giorno, chiamate da 5 minuti e rate limit sul tasto Next.",
            "Il piano Registrato include 15 match al giorno, chiamate da 10 minuti e filtro lingua.",
            "Il piano Premium costa 3,99 EUR al mese, non include prova gratuita e abilita match illimitati, chiamate da 30 minuti, filtri completi, priorità in coda, parola di sintonia 1:1 e Premium Card.",
